const SearchFilters = () => {
    return (
        <div className="h-[64px] flex flex-row items-center justify-between border rounded-full ">
            ...
            <div className="p-2">
                <div className="cursor-pointer lg:p-4 p-2 bg-airbnb hover:bg-airbnb-dark transition rounded-full ">
                    <svg xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 32 32" 
                    style={{display:'block', fill:'none', height:'16px', width:'16px', stroke: 'currentcolor', strokeWidth: 4, overflow: 'visible'}}
                    aria-hidden="true" role="presentation" focusable="false"
                    >
                        <path fill="none" d="M13 24a11 11 0 1 0 0-22 11 11 0 0 0 0 22zm8-3 9 9" style={{color: 'white'}}></path>
                    </svg>
                </div>
            </div>
        </div>
